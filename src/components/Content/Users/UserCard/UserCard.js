                ...
                <Grid item xs={9}>
                    <Item>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={4}>
                                <Typography variant="h5" align='right'  gutterBottom={true}>{props.location.citiName}</Typography>
                                <Typography variant="h5" align='right'  gutterBottom={true}>{props.location.countryName}</Typography>
                            </Grid>
                        </Grid>
                    </Item>
                </Grid>
